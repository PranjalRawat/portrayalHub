...
class MajorProjectsInfoModelTest(TestCase):
    ...
    def setUpTestData(self):
        ...
        MajorProjectsInfoModel.objects.create(**self.projectInfo)

    def test_project_info_str_method(self):
        project_info = MajorProjectsInfoModel.objects.get(id=1)
    ...
    def test_project_info_fields_update(self):
        ...
        project_info.save()
        updated_project_info = MajorProjectsInfoModel.objects.get(id=1)
    ...
    def test_project_info_deletion_with_direct_delete(self):
        ...
        self.assertTrue(MajorProjectsInfoModel.objects.filter(id=1).exists())
        project_info.delete()
        self.assertFalse(MajorProjectsInfoModel.objects.filter(id=1).exists())
